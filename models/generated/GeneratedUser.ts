...
export default class GeneratedUser extends RESTTable {
     ...
     * @returns
     */
    static async one(IDOrWhere: { id?: number , username?: string , name?: string , desc?: string , auth_key?: string , password_hash?: string , password_reset_token?: string , user_hash?: string , email?: string , phone?: string , avatar?: any , status?: number , created_at?: number , updated_at?: number , verification_token?: string  } | number | string, fields: {id?: number , username?: string , name?: string , desc?: string , auth_key?: string , password_hash?: string , password_reset_token?: string , user_hash?: string , email?: string , phone?: string , avatar?: any , status?: number , created_at?: number , updated_at?: number , verification_token?: string } | Array<string> | null = null, extfields?: object | Array<string>): Promise<User|null> {
     ...
     * @returns
     */
    static async all(params?: { where?: object, fields?: {id?: number , username?: string , name?: string , desc?: string , auth_key?: string , password_hash?: string , password_reset_token?: string , user_hash?: string , email?: string , phone?: string , avatar?: any , status?: number , created_at?: number , updated_at?: number , verification_token?: string } | Array<string>, extfields?: object | Array<string>, sort?: Array<"id"|"-id"|"username"|"-username"|"name"|"-name"|"desc"|"-desc"|"auth_key"|"-auth_key"|"password_hash"|"-password_hash"|"password_reset_token"|"-password_reset_token"|"user_hash"|"-user_hash"|"email"|"-email"|"phone"|"-phone"|"avatar"|"-avatar"|"status"|"-status"|"created_at"|"-created_at"|"updated_at"|"-updated_at"|"verification_token"|"-verification_token">, page?: number, perPage?: number, tree?: number }): Promise<Rows<User>> {
     ...
     * @param params
     */
    constructor(params?: {id?: number, username?: string, name?: string, desc?: string, auth_key: string, password_hash: string, password_reset_token?: string, user_hash?: string, email?: string, phone?: string, avatar?: any, status?: number, created_at: number, updated_at: number, verification_token?: string}) {
     ...
     * @param params
     */
    public static async create(params: {id?: number , username?: string , name?: string , desc?: string , auth_key?: string , password_hash?: string , password_reset_token?: string , user_hash?: string , email?: string , phone?: string , avatar?: any , status?: number , created_at?: number , updated_at?: number , verification_token?: string }, tree?: { appendTo?: number | string | null, insertAfter?: number | string | null, insertFirst?: number | string | null }): Promise<SavedObject<User>> {
     ...
     * @param params
     */
    public static async edit(ID: number | string, values: {id?: number, username?: string, name?: string, desc?: string, auth_key?: string, password_hash?: string, password_reset_token?: string, user_hash?: string, email?: string, phone?: string, avatar?: any, status?: number, created_at?: number, updated_at?: number, verification_token?: string}, tree?: { appendTo?: number | string | null, insertAfter?: number | string | null, insertFirst?: number | string | null }): Promise<SavedObject<User>> {
     ...
     * @param params
     */
    public static save(obj: GeneratedUser|null = null, values: { id?: number, username?: string, name?: string, desc?: string, auth_key: string, password_hash: string, password_reset_token?: string, user_hash?: string, email?: string, phone?: string, avatar?: any, status?: number, created_at: number, updated_at: number, verification_token?: string }): Promise<SavedObject<User>> {
