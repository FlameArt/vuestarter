...
.flex.justify-center.h-screen.items-center.flex-col
  ...
  .px-8.py-6.mt-4.text-left.bg-white.shadow-lg(class="lg:w-[700px]")
    .mt-0
      .h-4.mb-3.text-gray-400 Войти через
      .flex.text-sm.flex-col(class="lg:flex-row")
        ...
        a.flex.flex-1.items-center(
          ...
          span.pl-6 Facebook
    .h-4.mb-3.text-gray-400.text-xs.mt-4(class="lg:mt-6 lg:text-sm") Или с помощью почты и пароля
