<template>
  <div id="inputResult" class="text-left">
    <div class="row mb-4">
      <div class="col">
    ...
    <div class="row mb-4">
      <div class="col">
        ...
        <div class="descr">
          ...
          данных, предпринимаемые <span id="owner-name-value" class="link mark owner-name-field"
            data-scroll-to="#owner-name-field">{{ settingsFile().legal.OrganizationName.ru }}</span> (далее&nbsp;—
          Оператор).
        </div>
        <div class="ol">
          <div class="li">
          ...
          <div class="li">
            ...
            которую Оператор может получить о&nbsp; пользователях мобильного приложения <span
              class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">{{ settingsFile().appName
              }}</span>.
          </div>
        </div>
      </div>
      ...
      <div class="col">
        ...
        <div class="ol">
          ...
          <div class="li">
            ...
            их&nbsp;доступность в&nbsp;сети интернет приложения <span class="link mark owner-site-url-field"
              data-scroll-to="#owner-site-url-field">{{ settingsFile().appName }}</span>.
          </div>
          <div class="li">
          ...
          <div class="li">
            ...
            Пользователю мобильного приложения <span class="link mark owner-site-url-field"
              data-scroll-to="#owner-site-url-field">{{ settingsFile().appName }}</span>.
          </div>
          <div class="li">
          ...
          <div class="li">
            2.10. Пользователь&nbsp;— любой пользователь мобильного приложения <span
              class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">{{ settingsFile().appName
              }}</span>.
          </div>
          <div class="li">
    ...
    <div class="row mb-4">
      <div class="col">
        ...
        <div class="ol">
          <div id="za0Y6gFEH" class="li">
            <table class="purpose-table">
              <tbody>
                <tr>
                  <th>Цель обработки</th>
                  <td class="purpose-field">
                    <span class="mark link">предоставление доступа Пользователю к&nbsp;сервисам, информации
                      и/или&nbsp;материалам, содержащимся в мобильном приложении</span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="data-field">
                    <ul>
                      ...
                      <li><span class="mark link">фамилия и имя</span></li>
                      <li><span class="mark link">ссылки на соц-сети</span></li>
                    </ul>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="legal-field">
                    <ul>
                      <li>
                        <span class="mark link">договоры, заключаемые между оператором и&nbsp;субъектом персональных
                          данных</span>
                      </li>
                    </ul>
                  </td>
                ...
                <tr>
                  ...
                  <td class="types-field">
                    <ul>
                      <li>
                        <span class="mark link">Сбор, запись, систематизация, накопление, хранение, уничтожение
                          и&nbsp;обезличивание персональных данных</span>
                      </li>
                      <li>
      ...
      <div class="col">
        ...
        <div class="ol">
          ...
          <div class="li">
            ...
            Оператору уведомление на&nbsp;адрес электронной почты Оператора <span class="link mark owner-email-field"
              data-scroll-to="#owner-email-field">{{ settingsFile().legal.ContactEmail }}</span>
          ...
          <div class="li">
            ...
            посредством электронной почты на&nbsp;электронный адрес Оператора <span class="link mark owner-email-field"
              data-scroll-to="#owner-email-field">{{ settingsFile().legal.ContactEmail }}</span>
        ...
        <div class="ol">
          ...
          <div class="li">
            ...
            в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value"
              class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field">{{
                settingsFile().legal.URL.privacy }}</span>.
          </div>
        </div>
      </div>
    </div>
