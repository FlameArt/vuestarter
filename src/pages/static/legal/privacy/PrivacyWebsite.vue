      ...
      <div class="col">
        ...
        <div class="ol">
          ...
          <div class="li">
            ...
            которую Оператор может получить о&nbsp;посетителях веб-сайта <span class="link mark owner-site-url-field"
              data-scroll-to="#owner-site-url-field">{{ settingsFile().legal.URL.base }}</span>.
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="ol">
          ...
          <div class="li">
            ...
            их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span
              class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">{{ settingsFile().appURL
              }}</span>.
          </div>
          <div class="li">
          ...
          <div class="li">
            2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span class="link mark owner-site-url-field"
              data-scroll-to="#owner-site-url-field">{{ settingsFile().appURL }}</span>.
          </div>
          <div class="li">
                ...
                <tr>
                  ...
                  <td class="purpose-field">
                    <span class="mark link">предоставление доступа Пользователю к&nbsp;сервисам, информации
                      и/или&nbsp;материалам, содержащимся на&nbsp;веб-сайте</span>
                  </td>
                </tr>
                <tr>
          ...
          <div class="li">
            ...
            в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value"
              class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field">{{
                settingsFile().legal.URL.privacy
              }}</span>.
          </div>
        </div>
      </div>
